...
def analyze_game(
    ...
    #
    # Это отдельное хранилище.
    #
    # Оно НЕ используется для формирования текущего
    # анализа партии.
    # ==============================================================
    ...
    #
    # Этот файл содержит ТОЛЬКО ТЕКУЩУЮ
    # проанализированную часть партии.
    # ==============================================================
    ...
    # ==============================================================
    # ВОЗВРАЩАЕМ ИМЕННО ТЕКУЩИЕ ОШИБКИ
    #
    # Здесь НЕТ load_mistakes()
    # Здесь НЕТ load_analysis_results()
    #
    # Поэтому старые партии сюда попасть не могут.
    # ==============================================================
