...
function renderMyGameViewer() {
    ...
    /*
     * ============================================================
     * СОЗДАЁМ КОНТЕЙНЕР КООРДИНАТ ТОЛЬКО ОДИН РАЗ
     * ============================================================
     */
     ...
     *
     * ВАЖНО:
     * здесь мы НЕ создаём новые элементы.
     * Только меняем существующие span.
     * ============================================================
     */
    ...
    if (topCoordinates) {
        ...
        const spans =
            topCoordinates.querySelectorAll(
                "span"
            );
    ...
    if (bottomCoordinates) {
        ...
        const spans =
            bottomCoordinates.querySelectorAll(
                "span"
            );
    ...
    if (leftCoordinates) {
        ...
        const spans =
            leftCoordinates.querySelectorAll(
                "span"
            );
    ...
    if (rightCoordinates) {
        ...
        const spans =
            rightCoordinates.querySelectorAll(
                "span"
            );
